...
public class SerializeUtils {
	...
	public static byte[] serializegpswabePub(PublicParam pub) {
	...
	public static PublicParam unserializegpswabePub(byte[] b) {
		PublicParam pub;
		int offset;
		int len;
		...
		pub.comps=new ArrayList<PublicParamElement>();
		len=unserializeUint32(b, offset);
		offset+=4;

		for (int i=0;i<len; i++){
			PublicParamElement c=new PublicParamElement();
	...
	/* Method has been test okay */
	public static MasterKey unserializegpswabeMsk(PublicParam pub, byte[] b) {
		int offset = 0;
		...
		msk.comps=new ArrayList<MasterKeyElement>();
	...
	/* Method has been test okay */
	public static PrivateKey unserializegpswabePrv(PublicParam pub, byte[] b) {
	...
	public static Ciphertext gpswabeCphUnserialize(PublicParam pub, byte[] cphBuf) {
	 ...
	 */
	private static AbePolicy unserializePolicy(PublicParam pub, byte[] arr,
			int offset) {
		int i;
		int n;
