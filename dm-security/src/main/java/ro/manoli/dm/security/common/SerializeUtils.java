...
//	}
//
//	public static byte[] serializegpswabePub(PublicKey pub) {
//		ArrayList<Byte> arrlist = new ArrayList<Byte>();
//
//		serializeString(arrlist, pub.pairingDesc);
//		serializeElement(arrlist, pub.g);
//		serializeElement(arrlist, pub.Y);
//		serializeUint32(arrlist, pub.T.size());
//
//		for (int i=0; i<pub.T.size();i++){
//			serializeString(arrlist, pub.T.get(i).attr);
//			serializeElement(arrlist, pub.T.get(i).T_i);
//		}
...
//	 */
//
//	public static PublicKey unserializegpswabePub(byte[] b) {
//		PublicKey pub;
//		int offset;
//		int len;
//
...
//		
//		pub.p=PairingFactory.getPairing(SerializeUtils.class.getResource("a.properties").getFile());
...
//			c.T_i=pairing.getG1().newElement();
//			offset=unserializeElement(b, offset, c.T_i);
//			pub.T.add(c);
//		}
//		return pub;
//	}
//
//	/* Method has been test okay */
//	public static byte[] serializegpswabeMsk(MasterKey msk) {
//		ArrayList<Byte> arrlist = new ArrayList<Byte>();
//
//		serializeElement(arrlist, msk.y);
//		serializeUint32(arrlist, msk.t.size());
//		
//		for (int i=0; i<msk.t.size();i++){
//			serializeString(arrlist, msk.t.get(i).attr);
//			serializeElement(arrlist, msk.t.get(i).t);
//		}
//		return Byte_arr2byte_arr(arrlist);
//	}
//
//	/* Method has been test okay */
//	public static MasterKey unserializegpswabeMsk(PublicKey pub, byte[] b) {
//		int offset = 0;
...
//		msk.t=new ArrayList<MasterKeyElement>();
//		int len=unserializeUint32(b, offset);
//		offset+=4;
//		for(int i=0; i<len; i++){
//			MasterKeyElement c=new MasterKeyElement();
//			StringBuffer sb=new StringBuffer("");
//			offset=unserializeString(b, offset,sb);
...
//
//	/* Method has been test okay */
//	public static byte[] serializegpswabePrv(PrivateKey prv) {
...
//
//	/* Method has been test okay */
//	public static PrivateKey unserializegpswabePrv(PublicKey pub, byte[] b) {
...
//	 */
//	
//	public static byte[] gpswabeCphSerialize(Ciphertext cph) {
//		ArrayList<Byte> arrlist = new ArrayList<Byte>();
...
//	 */
//	
//	public static Ciphertext gpswabeCphUnserialize(PublicKey pub, byte[] cphBuf) {
...
//	 */
//	private static AbePolicy unserializePolicy(PublicKey pub, byte[] arr,
//			int offset) {
//		int i;
//		int n;
